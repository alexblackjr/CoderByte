...
function checkCashRegister(price, cash, cid) {
    var totalCid = 0, change = cash - price, valueCompare = [100.00, 20.00, 10.00, 5.00, 1.00, 0.25, 0.10, 0.05, 0.01], amountOfEach = {}, howMany = 0, getBack = [], first = 0, reverseMoneyOrder = arguments[2].reverse(), exactDrawer, remainingBalance, returnedAmount;
    //Cut off extra decimals
    function twoDecimals(z) {
        var strTotal = Math.fround(z).toString();
        var findDecimal = strTotal.indexOf(".");
        var cutoffPoint = findDecimal + 3;
...
//# sourceMappingURL=exactChange.js.map