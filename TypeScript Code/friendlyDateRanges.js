...
function makeFriendlyDates(arr) {
    var firstMonth = parseInt(arr[0].substr(5, 2)) - 1, secondMonth = parseInt(arr[1].substr(5, 2)) - 1, firstYear = parseInt(arr[0].match(/\d{4}/)), secondYear = parseInt(arr[1].match(/\d{4}/)), firstDay = parseInt(arr[0].substr(8, 2)), secondDay = parseInt(arr[1].substr(8, 2)), year = secondYear - firstYear, date = '', value = [], monthNames = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    for (var i = 0; i < monthNames.length; i++) {
        ...
        if (firstMonth === i) {
            ...
            if (year === 0 && ((secondMonth - firstMonth) === 0)) {
                value.push(date);
            ...
            if (secondMonth === firstMonth && year === 0) {
                ...
                for (var j = 0; j < monthNames.length; j++) {
                    ...
                    if ((year === 1 && ((secondMonth - firstMonth) < 0)) || (year === 1 && (secondMonth - firstMonth) === 0) && ((secondDay - firstDay) < 0)) {
                        value.push(date);
                        break;
                    }
                    else if (year > 0) {
...
//# sourceMappingURL=friendlyDateRanges.js.map